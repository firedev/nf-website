...
**`#where` после фото — текст Ника про выходные на Пхукете** (2026-09-08): короткие абзацы. Канон — надиктовка 07.09: «Остальное время я на Пхукете. Ныряем каждые выходные… отдыхаем сколько угодно, каждый в своём темпе… У нас своя лодка и свой катамаран.» Финал «We set the day as we go.» снят — это была калька, не его слова; «делаем что хотим» уже есть в «dive at our own pace». Не возвращать простыню «It all opens up» / «Independent training, Wave 3 certificate». Racha остаётся на `/about/`.
