(()=>{var o=Object.create;var c=Object.defineProperty;var b=Object.getOwnPropertyDescriptor;var U=Object.getOwnPropertyNames;var r=Object.getPrototypeOf,F=Object.prototype.hasOwnProperty;var C=(i,t)=>()=>(t||i((t={exports:{}}).exports,t),t.exports);var s=(i,t,g,a)=>{if(t&&typeof t=="object"||typeof t=="function")for(let Q of U(t))!F.call(i,Q)&&Q!==g&&c(i,Q,{get:()=>t[Q],enumerable:!(a=b(t,Q))||a.enumerable});return i};var n=(i,t,g)=>(g=i!=null?o(r(i)):{},s(t||!i||!i.__esModule?c(g,"default",{value:i,enumerable:!0}):g,i));var l=C((w,B)=>{var e=class{constructor(){this.currentTheme=this.getInitialTheme(),this.init()}getInitialTheme(){let t=localStorage.getItem("theme");return t&&(t==="light"||t==="dark")?t:window.matchMedia&&window.matchMedia("(prefers-color-scheme: dark)").matches?"dark":"light"}init(){this.applyTheme(this.currentTheme,!1),this.createToggleButton(),window.matchMedia&&window.matchMedia("(prefers-color-scheme: dark)").addListener(g=>{if(!localStorage.getItem("theme")){let a=g.matches?"dark":"light";this.currentTheme=a,this.applyTheme(a,!0),this.updateButtonState()}}),document.addEventListener("visibilitychange",()=>{if(!document.hidden&&!localStorage.getItem("theme")){let t=this.getSystemTheme();t!==this.currentTheme&&(this.currentTheme=t,this.applyTheme(t,!0),this.updateButtonState())}})}getSystemTheme(){return window.matchMedia&&window.matchMedia("(prefers-color-scheme: dark)").matches?"dark":"light"}createToggleButton(){let t=document.getElementById("theme-switcher");if(!t)return;let g=document.createElement("button");g.id="wha",g.setAttribute("aria-label","Toggle dark mode"),g.setAttribute("title","Toggle dark mode"),g.className="theme-toggle-btn";let a=this.createIcon("sun"),Q=this.createIcon("moon");g.appendChild(a),g.appendChild(Q),this.addToggleStyles(),g.style.cssText=`
      border: none;
      cursor: pointer;
    ...
    `,g.addEventListener("click",I=>{I.preventDefault(),this.toggle()}),t.appendChild(g),this.toggleButton=g,this.updateButtonState()}createIcon(t){let g=document.createElement("div");return g.className=`theme-icon theme-icon-${t}`,t==="sun"?g.innerHTML=`
