(()=>{var b=Object.create;var Q=Object.defineProperty;var o=Object.getOwnPropertyDescriptor;var C=Object.getOwnPropertyNames;var r=Object.getPrototypeOf,U=Object.prototype.hasOwnProperty;var F=(i,t)=>()=>(t||i((t={exports:{}}).exports,t),t.exports);var s=(i,t,g,I)=>{if(t&&typeof t=="object"||typeof t=="function")for(let a of C(t))!U.call(i,a)&&a!==g&&Q(i,a,{get:()=>t[a],enumerable:!(I=o(t,a))||I.enumerable});return i};var A=(i,t,g)=>(g=i!=null?b(r(i)):{},s(t||!i||!i.__esModule?Q(g,"default",{value:i,enumerable:!0}):g,i));var B=F((w,l)=>{var c=class{constructor(){this.currentTheme=this.getInitialTheme(),this.init()}getInitialTheme(){let t=localStorage.getItem("theme");return t&&(t==="light"||t==="dark")?t:window.matchMedia&&window.matchMedia("(prefers-color-scheme: dark)").matches?"dark":"light"}init(){this.applyTheme(this.currentTheme,!1),this.createToggleButton(),window.matchMedia&&window.matchMedia("(prefers-color-scheme: dark)").addListener(g=>{if(!localStorage.getItem("theme")){let I=g.matches?"dark":"light";this.currentTheme=I,this.applyTheme(I,!0),this.updateButtonState()}}),document.addEventListener("visibilitychange",()=>{if(!document.hidden&&!localStorage.getItem("theme")){let t=this.getSystemTheme();t!==this.currentTheme&&(this.currentTheme=t,this.applyTheme(t,!0),this.updateButtonState())}})}getSystemTheme(){return window.matchMedia&&window.matchMedia("(prefers-color-scheme: dark)").matches?"dark":"light"}createToggleButton(){let t=document.getElementById("theme-switcher");if(!t)return;let g=document.createElement("button");g.id="wha",g.setAttribute("aria-label","Toggle dark mode"),g.setAttribute("title","Toggle dark mode"),g.className="theme-toggle-btn";let I=this.createIcon("sun"),a=this.createIcon("moon");g.appendChild(I),g.appendChild(a),this.addToggleStyles(),g.style.cssText=`
      border: none;
      cursor: pointer;
