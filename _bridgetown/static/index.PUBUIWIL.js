(() => {
  ...
  // frontend/javascript/theme-switcher.js
  var require_theme_switcher = __commonJS({
    "frontend/javascript/theme-switcher.js"(exports, module) {
      var ThemeSwitcher = class {
        ...
        init() {
          ...
          if (window.matchMedia) {
            ...
            mediaQuery.addListener((e10) => {
              if (!localStorage.getItem("theme")) {
                const newTheme = e10.matches ? "dark" : "light";
  ...
  // src/_components/shared/navbar.js
  var require_navbar = __commonJS({
    "src/_components/shared/navbar.js"() {
      function menuShow(toggler) {
        ...
        ;
        return toggler.querySelector("sl-icon").name = "system/close";
      }
  ...
  // node_modules/@shoelace-style/shoelace/node_modules/@lit/reactive-element/css-tag.js
  var t = globalThis;
  ...
  // node_modules/@shoelace-style/shoelace/node_modules/@lit/reactive-element/reactive-element.js
  ...
  var b = class extends HTMLElement {
    ...
    requestUpdate(t6, s4, i7) {
      if (void 0 !== t6) {
        if (i7 ?? (i7 = this.constructor.getPropertyOptions(t6)), !(i7.hasChanged ?? f)(this[t6], s4))
          return;
        this.P(t6, s4, i7);
      }
    ...
    performUpdate() {
      ...
      if (!this.hasUpdated) {
        ...
        if (t7.size > 0)
          for (const [s5, i7] of t7)
            true !== i7.wrapped || this._$AL.has(s5) || void 0 === this[s5] || this.P(s5, this[s5], i7);
      }
      let t6 = false;
      const s4 = this._$AL;
      try {
...
\f\r"'\`<>=]|("|')|))|$)`, "g");
  ...
  var V = (t6, i7) => {
    ...
    let r9, l5 = 2 === i7 ? "<svg>" : 3 === i7 ? "<math>" : "", c6 = f2;
    for (let i8 = 0; i8 < s4; i8++) {
      const s5 = t6[i8];
      let a4, u5, d3 = -1, y3 = 0;
      for (; y3 < s5.length && (c6.lastIndex = y3, u5 = c6.exec(s5), null !== u5); )
        y3 = c6.lastIndex, c6 === f2 ? "!--" === u5[1] ? c6 = v : void 0 !== u5[1] ? c6 = _ : void 0 !== u5[2] ? ($.test(u5[2]) && (r9 = RegExp("</" + u5[2], "g")), c6 = m) : void 0 !== u5[3] && (c6 = m) : c6 === m ? ">" === u5[0] ? (c6 = r9 ?? f2, d3 = -1) : void 0 === u5[1] ? d3 = -2 : (d3 = c6.lastIndex - u5[2].length, a4 = u5[1], c6 = void 0 === u5[3] ? m : '"' === u5[3] ? g : p2) : c6 === g || c6 === p2 ? c6 = m : c6 === v || c6 === _ ? c6 = f2 : (c6 = m, r9 = void 0);
      const x2 = c6 === m && t6[i8 + 1].startsWith("/>") ? " " : "";
      l5 += c6 === f2 ? s5 + n3 : d3 >= 0 ? (o10.push(a4), s5.slice(0, d3) + e3 + s5.slice(d3) + h2 + x2) : s5 + h2 + (-2 === d3 ? i8 : x2);
    }
    return [P(t6, l5 + (t6[s4] || "<?>") + (2 === i7 ? "</svg>" : 3 === i7 ? "</math>" : "")), o10];
  };
  var N = class _N {
      ...
      for (; null !== (r9 = C.nextNode()) && d3.length < u5; ) {
        if (1 === r9.nodeType) {
          if (r9.hasAttributes())
            for (const t7 of r9.getAttributeNames())
              if (t7.endsWith(e3)) {
                ...
                t7.startsWith(h2) && (d3.push({ type: 6, index: c6 }), r9.removeAttribute(t7));
          if ($.test(r9.tagName)) {
            const t7 = r9.textContent.split(h2), s5 = t7.length - 1;
            if (s5 > 0) {
              r9.textContent = i3 ? i3.emptyScript : "";
              for (let i7 = 0; i7 < s5; i7++)
                r9.append(t7[i7], l2()), C.nextNode(), d3.push({ type: 2, index: ++c6 });
              r9.append(t7[s5], l2());
            }
          }
          ...
          if (r9.data === o3)
            ...
            let t7 = -1;
            for (; -1 !== (t7 = r9.data.indexOf(h2, t7 + 1)); )
              d3.push({ type: 7, index: c6 }), t7 += h2.length - 1;
          }
        c6++;
      }
    }
  ...
  var M = class {
    ...
    u(t6) {
      ...
      for (; void 0 !== l5; ) {
        if (o10 === l5.index) {
          let i8;
          2 === l5.type ? i8 = new R(h5, h5.nextSibling, this, t6) : 1 === l5.type ? i8 = new l5.ctor(h5, l5.name, l5.strings, this, t6) : 6 === l5.type && (i8 = new z(h5, this, t6)), this._$AV.push(i8), l5 = s4[++n8];
        }
    ...
    p(t6) {
      ...
      for (const s4 of this._$AV)
        void 0 !== s4 && (void 0 !== s4.strings ? (s4._$AI(t6, s4, i7), i7 += s4.strings.length - 2) : s4._$AI(t6[i7])), i7++;
    }
  };
  var R = class _R {
    get _$AU() {
    ...
    k(t6) {
      ...
      let s4, e10 = 0;
      for (const h5 of t6)
        e10 === i7.length ? i7.push(s4 = new _R(this.O(l2()), this.O(l2()), this, this.options)) : s4 = i7[e10], s4._$AI(h5), e10++;
  ...
  var k = class {
    ...
    _$AI(t6, i7 = this, s4, e10) {
      ...
      let o10 = false;
      if (void 0 === h5)
        t6 = S2(this, t6, i7, 0), o10 = !c3(t6) || t6 !== this._$AH && t6 !== T, o10 && (this._$AH = t6);
      else {
        const e11 = t6;
        let n8, r9;
        for (t6 = h5[0], n8 = 0; n8 < h5.length - 1; n8++)
          r9 = S2(this, e11[s4 + n8], i7, n8), r9 === T && (r9 = this._$AH[n8]), o10 || (o10 = !c3(r9) || r9 !== this._$AH[n8]), r9 === E ? t6 = E : t6 !== E && (t6 += (r9 ?? "") + h5[n8 + 1]), this._$AH[n8] = r9;
      }
      o10 && !e10 && this.j(t6);
    }
    j(t6) {
...
`;
  ...
  // node_modules/@shoelace-style/shoelace/node_modules/@lit/reactive-element/decorators/property.js
  ...
  // node_modules/@shoelace-style/shoelace/node_modules/@lit/reactive-element/decorators/state.js
  function r6(r9) {
    return n4({ ...r9, state: true, attribute: false });
  }

  // node_modules/@shoelace-style/shoelace/node_modules/@lit/reactive-element/decorators/base.js
  var e4 = (e10, t6, c6) => (c6.configurable = true, c6.enumerable = true, Reflect.decorate && "object" != typeof t6 && Object.defineProperty(e10, t6, c6), c6);

  // node_modules/@shoelace-style/shoelace/node_modules/@lit/reactive-element/decorators/query.js
  function e5(e10, r9) {
    return (n8, s4, i7) => {
  ...
  var FormControlController = class {
    ...
    setUserInteracted(el2, hasInteracted) {
      if (hasInteracted) {
        userInteractedControls.add(el2);
      } else {
        userInteractedControls.delete(el2);
      }
      el2.requestUpdate();
    }
...
`;
  ...
  function unwatchIcon(icon) {
    watchedIcons = watchedIcons.filter((el2) => el2 !== icon);
  }
...
`;
  ...
  var e8 = e7(class extends i5 {
    ...
    update(s4, [i7]) {
      ...
      for (const t6 of this.st)
        t6 in i7 || (r9.remove(t6), this.st.delete(t6));
      for (const t6 in i7) {
        const s5 = !!i7[t6];
  ...
  var i6 = (t6, ...r9) => ({ _$litStatic$: r9.reduce((r10, e10, a4) => r10 + ((t7) => {
  ...
  var n5 = (t6) => (r9, ...e10) => {
    ...
    let c6, $3 = 0, f5 = false;
    for (; $3 < a4; ) {
      for (c6 = r9[$3]; $3 < a4 && void 0 !== (i7 = e10[$3], s4 = o5(i7)); )
        c6 += s4 + r9[++$3], f5 = true;
      $3 !== a4 && u5.push(i7), n8.push(c6), $3++;
    }
    if ($3 === a4 && n8.push(r9[a4]), f5) {
      const t7 = n8.join("$$lit$$");
      void 0 === (r9 = l3.get(t7)) && (n8.raw = n8, l3.set(t7, r9 = n8)), e10 = u5;
    }
    return t6(r9, ...e10);
  };
  var u4 = n5(x);
  ...
  // node_modules/@shoelace-style/shoelace/dist/chunks/chunk.EHUQAWJK.js
  SlSpinner.define("sl-spinner");

  // frontend/javascript/testimonials.js
  var testimonials = [
    ...
    "\u0420\u0435\u0431\u0435\u043D\u043E\u043A \u0441\u0442\u0430\u043B \u0431\u043E\u043B\u0435\u0435 \u0441\u043F\u043E\u043A\u043E\u0439\u043D\u044B\u0439. \u041E\u043D \u0432\u0440\u043E\u0434\u0435 \u0442\u0430\u043A\u043E\u0439 \u0436\u0435, \u043D\u043E \u043F\u0440\u043E\u0441\u0442\u043E \u0440\u043E\u0432\u043D\u0435\u0435. \u0421\u043F\u0430\u0441\u0438\u0431\u043E \u{1F44D}",
    ...
    "The child has become calmer. He's the same, but just more even-tempered. Thanks \u{1F44D}.",
    ...
    "\u041A\u043E\u043B\u044F, \u043F\u0440\u0438\u0432\u0435\u0442, \u0443 \u043C\u0435\u043D\u044F \u0442\u0443\u0442 \u0432\u0441\u0435 \u0441\u0442\u0430\u043D\u043E\u0432\u0438\u0442\u0441\u044F \u043D\u0430 \u0441\u0432\u043E\u0438 \u043C\u0435\u0441\u0442\u0430 \u0432 \u0433\u043E\u043B\u043E\u0432\u0435 \u0438 \u0443\u043A\u043B\u0430\u0434\u044B\u0432\u0435\u0442\u0441\u044F, \u043A\u0430\u043A \u043D\u0430\u0434\u043E! \u041F\u0440\u043E\u0446\u0435\u0441\u0441 \u0438\u0434\u0435\u0442! \u0421\u043F\u0430\u0441\u0438\u0431\u043E \u0432\u0430\u043C \u043E\u0431\u043E\u0438\u043C, \u0432\u044B \u0434\u0430\u0436\u0435 \u043D\u0435 \u043F\u0440\u0435\u0434\u0441\u0442\u0430\u0432\u043B\u044F\u0435\u0442\u0435, \u0447\u0442\u043E \u0432\u044B \u0441\u0434\u0435\u043B\u0430\u043B\u0438 \u{1F600}",
    "\u0422\u0435\u043F\u0435\u0440\u044C \u0431\u0443\u0434\u0443 \u0432\u044B\u0431\u0438\u0432\u0430\u0442\u044C \u0441\u043B\u0435\u0434\u0443\u044E\u0449\u0443\u044E \u043A\u043E\u043C\u0430\u043D\u0434\u0438\u0440\u043E\u0432\u043A\u0443 \u0441\u044E\u0434\u0430 \u{1F600}",
    ...
    "\u0421\u0435\u0439\u0447\u0430\u0441 \u0442\u0430\u043A\u043E\u0435 \u0441\u043E\u0441\u0442\u043E\u044F\u043D\u0438\u0435 \u043D\u0430\u043F\u043E\u043B\u043D\u0435\u043D\u043D\u043E\u0441\u0442\u0438. \u041D\u0435 \u0445\u043E\u0447\u0435\u0442\u0441\u044F \u0440\u0430\u0441\u043F\u043B\u0435\u0441\u043A\u0430\u0442\u044C, \u043A\u043E\u0433\u0434\u0430 \u043D\u0430\u0447\u043D\u0435\u0442\u0441\u044F \u043E\u0431\u044B\u0447\u043D\u0430\u044F \u0436\u0438\u0437\u043D\u044C \u0432\u043D\u0435 \u041F\u0445\u0443\u043A\u0435\u0442\u0430 \u{1F600}",
    ...
    "\u0423 \u043C\u0435\u043D\u044F \u0432 \u0433\u043E\u043B\u043E\u0432\u0435 \u043F\u043E\u044F\u0432\u0438\u043B\u0441\u044F \u0441\u043C\u044B\u0441\u043B \u{1F600}",
    ...
    "Hello, Kolya, everything's falling into place in my head and settling as it should! The process is ongoing! Thank you both, you can't even imagine what you've done \u{1F600}.",
    "Now I'll be vying for another trip here \u{1F600}.",
    ...
    "Currently, I'm in a state of fulfillment. Don't want to spill it when regular life starts outside Phuket \u{1F600}.",
    ...
    "A sense of purpose has emerged in my mind \u{1F600}.",
    ...
    "\u0411\u044B\u043B \u043C\u043E\u043C\u0435\u043D\u0442 \u043A\u043E\u0433\u0434\u0430 \u044F \u0438\u0441\u043F\u0443\u0433\u0430\u043B\u0430\u0441\u044C \u0447\u0442\u043E \u044F \u043D\u0435 \u0432\u0435\u0440\u043D\u0443\u0441\u044C \u0432 \xAB\u043D\u043E\u0440\u043C\u0430\u043B\u044C\u043D\u0443\u044E \u0436\u0438\u0437\u043D\u044C \u0441 \u043F\u044F\u0442\u0435\u0440\u043E\u0447\u043A\u043E\u0439\xBB",
    "\u042F \u0432\u0441\u0435 \u043F\u043E\u043C\u043D\u044E!",
    ...
    "Bro if you have the secret powers to sort people out, do it as much as possible I say \u{1F601}",
    "I wish I\u2019d started sooner as well \u{1F62C} This is amazing man!",
    ...
    "Don't remember much else about BKK than the crazy Russian \u{1F60B}",
  ...
  if (testimonialContainer) {
    setTimeout(() => {
      setInterval(showTestimonials, 6e3);
    }, 6e3);
  }

  // frontend/javascript/lifeline.js
  var life = ["IN CONTROL", "IN LINE", "IN ORDER", "IN YOUR HANDS", "IN ALIGNMENT", "IN BALANCE", "IN BLOOM", "IN CONTROL", "IN FOCUS", "IN GEAR", "IN HARMONY", "IN MOTION", "IN ORDER", "IN PERSPECTIVE", "IN RHYTHM", "IN SHAPE", "IN SYNC", "IN THE GROOVE", "IN THE MIX", "IN THE RING", "IN THE SADDLE", "IN TOUCH", "IN TUNE"];
  var el;
  var lifeline = function() {
    if (el = document.getElementById("lifeline")) {
      el.innerText = life[Math.floor(Math.random() * life.length)];
      setTimeout(lifeline, 3e3);
    }
  };
  setTimeout(lifeline, 3e3);

  // frontend/javascript/index.js
  var import_theme_switcher = __toESM(require_theme_switcher());
...
`;
  ...
  function getAnimation(el2, animationName, options) {
    const customAnimation = customAnimationRegistry.get(el2);
  ...
  function waitForEvent(el2, eventName) {
    return new Promise((resolve) => {
      function done(event) {
        if (event.target === el2) {
          el2.removeEventListener(eventName, done);
          resolve();
        }
      }
      el2.addEventListener(eventName, done);
    });
  }

  // node_modules/@shoelace-style/shoelace/dist/chunks/chunk.3EPZX5HE.js
  function animateTo(el2, keyframes, options) {
    return new Promise((resolve) => {
      if ((options == null ? void 0 : options.duration) === Infinity) {
        throw new Error("Promise-based animations must be finite.");
      }
      const animation = el2.animate(keyframes, __spreadProps(__spreadValues({}, options), {
  ...
  function stopAnimations(el2) {
    return Promise.all(
      el2.getAnimations().map((animation) => {
        return new Promise((resolve) => {
          animation.cancel();
...
`;
  ...
  // node_modules/@shoelace-style/shoelace/dist/chunks/chunk.YK3ND3ZE.js
...
`;
  ...
  // node_modules/@shoelace-style/shoelace/dist/chunks/chunk.VY7A362G.js
  ...
  // node_modules/@shoelace-style/shoelace/dist/chunks/chunk.HXPETTOW.js
...
`;
  ...
  // node_modules/@shoelace-style/shoelace/dist/chunks/chunk.IWQPAFKH.js
  var SlBreadcrumb = class extends ShoelaceElement {
    ...
    getSeparator() {
      ...
      [clone, ...clone.querySelectorAll("[id]")].forEach((el2) => el2.removeAttribute("id"));
  ...
  // node_modules/@shoelace-style/shoelace/dist/chunks/chunk.Q2DXIELC.js
...
`;
  ...
  // node_modules/@shoelace-style/shoelace/dist/chunks/chunk.RQ7GF3MZ.js
  var SlBreadcrumbItem = class extends ShoelaceElement {
    ...
    setRenderType() {
      const hasDropdown = this.defaultSlot.assignedElements({ flatten: true }).filter((i7) => i7.tagName.toLowerCase() === "sl-dropdown").length > 0;
      if (this.href) {
...
`;
  ...
  function getCachedComputedStyle(el2) {
    let computedStyle = computedStyleMap.get(el2);
    if (!computedStyle) {
      computedStyle = window.getComputedStyle(el2, null);
      computedStyleMap.set(el2, computedStyle);
    }
    return computedStyle;
  }
  function isVisible(el2) {
    if (typeof el2.checkVisibility === "function") {
      return el2.checkVisibility({ checkOpacity: false, checkVisibilityCSS: true });
    }
    const computedStyle = getCachedComputedStyle(el2);
    return computedStyle.visibility !== "hidden" && computedStyle.display !== "none";
  }
  function isOverflowingAndTabbable(el2) {
    const computedStyle = getCachedComputedStyle(el2);
    ...
    const isOverflowingY = el2.scrollHeight > el2.clientHeight;
    if (isOverflowingY && overflowY === "auto") {
      return true;
    }
    const isOverflowingX = el2.scrollWidth > el2.clientWidth;
  ...
  function isTabbable(el2) {
    ...
    const tabindex = Number(el2.getAttribute("tabindex"));
    const hasTabindex = el2.hasAttribute("tabindex");
    ...
    if (el2.closest("[inert]")) {
      return false;
    }
    if (tag === "input" && el2.getAttribute("type") === "radio" && !el2.hasAttribute("checked")) {
      return false;
    }
    if (!isVisible(el2)) {
      return false;
    }
    if ((tag === "audio" || tag === "video") && el2.hasAttribute("controls")) {
      return true;
    }
    if (el2.hasAttribute("tabindex")) {
      return true;
    }
    if (el2.hasAttribute("contenteditable") && el2.getAttribute("contenteditable") !== "false") {
      return true;
    }
    ...
    return isOverflowingAndTabbable(el2);
  }
  ...
  function getTabbableElements(root) {
    ...
    function walk(el2) {
      if (el2 instanceof Element) {
        if (el2.hasAttribute("inert") || el2.closest("[inert]")) {
          return;
        }
        if (walkedEls.has(el2)) {
          return;
        }
        walkedEls.set(el2, true);
        if (!tabbableElements.includes(el2) && isTabbable(el2)) {
          tabbableElements.push(el2);
        }
        if (el2 instanceof HTMLSlotElement && getSlottedChildrenOutsideRootElement(el2, root)) {
          el2.assignedElements({ flatten: true }).forEach((assignedEl) => {
            walk(assignedEl);
          });
        }
        if (el2.shadowRoot !== null && el2.shadowRoot.mode === "open") {
          walk(el2.shadowRoot);
        }
      }
      for (const e10 of el2.children) {
        walk(e10);
      }
    }
    walk(root);
  ...
  var Modal = class {
    constructor(element) {
      ...
      this.handleKeyDown = (event) => {
        ...
        let currentFocusIndex = tabbableElements.findIndex((el2) => el2 === currentActiveElement);
...
`;
  ...
  // node_modules/@shoelace-style/shoelace/dist/chunks/chunk.6MYQMWFA.js
...
`;
  ...
  // node_modules/@shoelace-style/shoelace/dist/chunks/chunk.2P4ISAJG.js
...
`;
  ...
  // node_modules/@shoelace-style/shoelace/dist/chunks/chunk.ZSH6VD4N.js
  var SlDropdown = class extends ShoelaceElement {
    ...
    getMenu() {
      return this.panel.assignedElements({ flatten: true }).find((el2) => el2.tagName.toLowerCase() === "sl-menu");
    }
    handleTriggerClick() {
      if (this.open) {
        this.hide();
    ...
    updateAccessibleTrigger() {
      ...
      const accessibleTrigger = assignedElements.find((el2) => getTabbableBoundary(el2).start);
      let target;
  ...
  // node_modules/@shoelace-style/shoelace/dist/chunks/chunk.QVOIHCVY.js
...
`;
  ...
  var l4 = e7(class extends i5 {
    ...
    update(i7, [t6]) {
      if (t6 === T || t6 === E)
        return t6;
      const o10 = i7.element, l5 = i7.name;
      if (i7.type === t4.PROPERTY) {
        ...
        if (!!t6 === o10.hasAttribute(l5))
          return T;
      } else if (i7.type === t4.ATTRIBUTE && o10.getAttribute(l5) === t6 + "")
        return T;
      return m2(i7), t6;
    }
  });
...
`;
  ...
  // node_modules/@shoelace-style/shoelace/dist/chunks/chunk.ZNAKKORO.js
  var SlMenu = class extends ShoelaceElement {
    ...
    handleClick(event) {
      ...
      const target = composedPath.find((el2) => {
        var _a;
        return menuItemTypes.includes(((_a = el2 == null ? void 0 : el2.getAttribute) == null ? void 0 : _a.call(el2, "role")) || "");
      });
      if (!target)
        return;
      const closestMenu = composedPath.find((el2) => {
        var _a;
        return ((_a = el2 == null ? void 0 : el2.getAttribute) == null ? void 0 : _a.call(el2, "role")) === "menu";
      });
    ...
    getAllItems() {
      return [...this.defaultSlot.assignedElements({ flatten: true })].filter((el2) => {
        if (el2.inert || !this.isMenuItem(el2)) {
          return false;
        }
        return true;
      });
...
`;
  ...
  // node_modules/@shoelace-style/shoelace/node_modules/lit-html/async-directive.js
  var s3 = (i7, t6) => {
    const e10 = i7._$AN;
    if (void 0 === e10)
      return false;
    for (const i8 of e10)
      i8._$AO?.(t6, false), s3(i8, t6);
    return true;
  };
  var o8 = (i7) => {
    let t6, e10;
  ...
  function h3(i7) {
    void 0 !== this._$AN ? (o8(this), this._$AM = i7, r8(this)) : this._$AM = i7;
  }
  function n6(i7, t6 = false, e10 = 0) {
    const r9 = this._$AH, h5 = this._$AN;
    if (void 0 !== h5 && 0 !== h5.size)
      if (t6)
        if (Array.isArray(r9))
          for (let i8 = e10; i8 < r9.length; i8++)
            s3(r9[i8], false), o8(r9[i8]);
        else
          null != r9 && (s3(r9, false), o8(r9));
      else
        s3(this, i7);
  }
  var c5 = (i7) => {
    i7.type == t4.CHILD && (i7._$AP ?? (i7._$AP = n6), i7._$AQ ?? (i7._$AQ = h3));
  };
  var f4 = class extends i5 {
    ...
    _$AO(i7, t6 = true) {
      i7 !== this.isConnected && (this.isConnected = i7, i7 ? this.reconnected?.() : this.disconnected?.()), t6 && (s3(this, i7), o8(this));
    }
    setValue(t6) {
      if (f3(this._$Ct))
  ...
  // node_modules/@shoelace-style/shoelace/node_modules/lit-html/directives/ref.js
  var e9 = () => new h4();
  var h4 = class {
  };
  ...
  var n7 = e7(class extends f4 {
    ...
    rt(t6) {
      if (this.isConnected || (t6 = void 0), "function" == typeof this.Y) {
        ...
        let s4 = o9.get(i7);
        void 0 === s4 && (s4 = /* @__PURE__ */ new WeakMap(), o9.set(i7, s4)), void 0 !== s4.get(this.Y) && this.Y.call(this.ht, void 0), s4.set(this.Y, t6), void 0 !== t6 && this.Y.call(this.ht, t6);
      } else
        this.Y.value = t6;
    }
    get lt() {
  ...
  var SubmenuController = class {
    constructor(host, hasSlotController) {
      ...
      this.handlePopupReposition = () => {
        ...
        const menu = submenuSlot == null ? void 0 : submenuSlot.assignedElements({ flatten: true }).filter((el2) => el2.localName === "sl-menu")[0];
  ...
  // node_modules/@shoelace-style/shoelace/dist/chunks/chunk.22WT5API.js
  ...
  // node_modules/@shoelace-style/shoelace/dist/chunks/chunk.I2JSEN3V.js
...
`;
  ...
  // import-glob:../../src/_components/**/*.{js,jsx,js.rb,css}
  var module3 = __toESM(require_navbar());
...
lit-html/directives/ref.js:
   ...
   *)
*/
//# sourceMappingURL=/_bridgetown/static/index.PUBUIWIL.js.map
