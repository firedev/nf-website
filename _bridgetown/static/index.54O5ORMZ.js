(()=>{var b=Object.create;var I=Object.defineProperty;var o=Object.getOwnPropertyDescriptor;var U=Object.getOwnPropertyNames;var F=Object.getPrototypeOf,r=Object.prototype.hasOwnProperty;var C=(i,t)=>()=>(t||i((t={exports:{}}).exports,t),t.exports);var s=(i,t,g,Q)=>{if(t&&typeof t=="object"||typeof t=="function")for(let a of U(t))!r.call(i,a)&&a!==g&&I(i,a,{get:()=>t[a],enumerable:!(Q=o(t,a))||Q.enumerable});return i};var n=(i,t,g)=>(g=i!=null?b(F(i)):{},s(t||!i||!i.__esModule?I(g,"default",{value:i,enumerable:!0}):g,i));var B=C((w,l)=>{var c=class{constructor(){this.currentTheme=this.getInitialTheme(),this.init()}getInitialTheme(){let t=localStorage.getItem("theme");return t&&(t==="light"||t==="dark")?t:window.matchMedia&&window.matchMedia("(prefers-color-scheme: dark)").matches?"dark":"light"}init(){this.applyTheme(this.currentTheme,!1),this.createToggleButton(),window.matchMedia&&window.matchMedia("(prefers-color-scheme: dark)").addListener(g=>{if(!localStorage.getItem("theme")){let Q=g.matches?"dark":"light";this.currentTheme=Q,this.applyTheme(Q,!0),this.updateButtonState()}}),document.addEventListener("visibilitychange",()=>{if(!document.hidden&&!localStorage.getItem("theme")){let t=this.getSystemTheme();t!==this.currentTheme&&(this.currentTheme=t,this.applyTheme(t,!0),this.updateButtonState())}})}getSystemTheme(){return window.matchMedia&&window.matchMedia("(prefers-color-scheme: dark)").matches?"dark":"light"}createToggleButton(){let t=document.getElementById("theme-switcher");if(!t)return;let g=document.createElement("button");g.id="wha",g.setAttribute("aria-label","Toggle dark mode"),g.setAttribute("title","Toggle dark mode"),g.className="theme-toggle-btn";let Q=this.createIcon("sun"),a=this.createIcon("moon");g.appendChild(Q),g.appendChild(a),this.addToggleStyles(),g.style.cssText=`
      border: none;
      cursor: pointer;
    ...
    `,g.addEventListener("click",e=>{e.preventDefault(),this.toggle()}),t.appendChild(g),this.toggleButton=g,this.updateButtonState()}createIcon(t){let g=document.createElement("div");return g.className=`theme-icon theme-icon-${t}`,t==="sun"?g.innerHTML=`
