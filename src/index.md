...
<section class="home-hero relative isolate flex min-h-[100dvh] items-center overflow-hidden text-white">
  ...
  <div class="relative z-1 mx-auto w-full max-w-7xl px-6 pb-16 pt-32 sm:px-10 lg:px-12">
    <div class="max-w-3xl">
      ...
      <p class="mb-8 max-w-2xl text-lg leading-relaxed text-slate-100 sm:text-xl">Learn to relax, equalize and move efficiently on one breath, in the pool or at depth.</p>
...
<section id="nofins" class="bg-sky-950 text-slate-100 dark:bg-slate-950">
  <div class="mx-auto grid max-w-7xl items-center gap-12 px-6 py-20 sm:px-10 sm:py-28 md:grid-cols-2 md:gap-16 lg:px-12">
    ...
    <div>
      ...
      <p class="mb-0 text-lg leading-relaxed text-slate-300">No-fins develops efficient movement through coordination and feel. The line, lanyard and buddy provide a clear, safe setup.</p>
    </div>
  </div>
</section>
